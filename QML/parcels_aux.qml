...
<qgis labelsEnabled="1" simplifyAlgorithm="0" readOnly="0" styleCategories="AllStyleCategories" version="3.18.2-Zürich" minScale="50000" simplifyDrawingHints="1" maxScale="0" hasScaleBasedVisibilityFlag="1" simplifyMaxScale="1" simplifyLocal="1" simplifyDrawingTol="1">
  <flags>
  ...
  <temporal fixedDuration="0" accumulate="0" startField="" endField="last_edited" durationUnit="min" endExpression="" durationField="" mode="0" enabled="0" startExpression="">
    <fixedRange>
      <start></start>
      <end></end>
    </fixedRange>
  ...
  <labeling type="rule-based">
    <rules key="{ef7c846c-d32a-4519-8cd4-0a826645a727}">
      <rule key="{9dfce7c1-f2af-48cc-94b3-705ad01c7012}">
        <settings calloutType="simple">
          <text-style fontSizeMapUnitScale="3x:0,0,0,0,0,0" textColor="0,0,0,255" blendMode="0" fontSize="7" fontUnderline="0" fontStrikeout="0" capitalization="0" namedStyle="Regular" fontFamily="MS Shell Dlg 2" textOpacity="1" fontWeight="50" fontItalic="0" fontWordSpacing="0" fontSizeUnit="Point" fontKerning="1" useSubstitutions="0" textOrientation="horizontal" multilineHeight="1" allowHtml="0" previewBkgrdColor="255,255,255,255" fontLetterSpacing="0" isExpression="1" fieldName="left(&quot;owner1&quot;,30) || &#xd;&#xa;case when &quot;owner2&quot; is NOT NULL then '\n' || &quot;owner2&quot; || '\n' || &#xd;&#xa;case when &quot;own_addr2&quot; is NOT NULL then &quot;own_addr1&quot; || '\n' || &quot;own_addr2&quot; || '\n' || &quot;own_city&quot; || ', ' || &quot;own_state&quot; || ' ' || &#xd;&#xa;&quot;own_zip&quot; || '\n' || &quot;rawdeeds&quot;&#xd;&#xa;else &quot;own_addr1&quot; || '\n' || &quot;own_city&quot; || ', ' || &quot;own_state&quot; || ' ' || &#xd;&#xa;&quot;own_zip&quot; || '\n' || &quot;rawdeeds&quot;&#xd;&#xa;end&#xd;&#xa;else '\n' || &quot;own_addr1&quot; || '\n' ||&quot;own_city&quot; || ', ' || &quot;own_state&quot; || ' ' || &#xd;&#xa;&quot;own_zip&quot; || '\n' || &quot;rawdeeds&quot;&#xd;&#xa;end">
            <text-buffer bufferSizeUnits="MM" bufferNoFill="1" bufferBlendMode="0" bufferDraw="0" bufferSize="1" bufferOpacity="1" bufferJoinStyle="128" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferColor="255,255,255,255"/>
            <text-mask maskedSymbolLayers="" maskEnabled="0" maskSizeUnits="MM" maskSizeMapUnitScale="3x:0,0,0,0,0,0" maskType="0" maskJoinStyle="128" maskOpacity="1" maskSize="1.5"/>
          ...
          <text-format addDirectionSymbol="0" leftDirectionSymbol="&lt;" rightDirectionSymbol=">" placeDirectionSymbol="0" plussign="0" autoWrapLength="0" reverseDirectionSymbol="0" multilineAlign="3" formatNumbers="0" useMaxLineLengthForAutoWrap="1" decimals="3" wrapChar=""/>
          <placement offsetType="0" yOffset="10" fitInPolygonOnly="0" dist="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" lineAnchorPercent="0.5" distUnits="MM" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" layerType="PolygonGeometry" geometryGenerator="" preserveRotation="1" repeatDistance="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" offsetUnits="MM" priority="5" lineAnchorType="0" geometryGeneratorType="PointGeometry" maxCurvedCharAngleOut="-25" quadOffset="4" placementFlags="10" placement="1" overrunDistance="0" overrunDistanceUnit="MM" maxCurvedCharAngleIn="25" repeatDistanceUnits="MM" distMapUnitScale="3x:0,0,0,0,0,0" xOffset="0" centroidInside="0" rotationAngle="0" centroidWhole="0" geometryGeneratorEnabled="0" polygonPlacementFlags="2"/>
          <rendering obstacleFactor="1" fontMinPixelSize="3" mergeLines="0" drawLabels="1" displayAll="1" limitNumLabels="0" scaleMax="1500" obstacle="1" labelPerPart="0" fontLimitPixelSize="0" fontMaxPixelSize="10000" zIndex="0" maxNumLabels="2000" scaleVisibility="1" obstacleType="1" upsidedownLabels="0" minFeatureSize="0" scaleMin="1"/>
          <dd_properties>
            <Option type="Map">
              <Option value="" name="name" type="QString"/>
              <Option name="properties"/>
